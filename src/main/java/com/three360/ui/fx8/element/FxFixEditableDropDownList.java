 ...
 */
public class FxFixEditableDropDownList implements IFixEditableDropDownListUiElement<HBox, EventHandler<ActionEvent>> {
    ...
    public HBox create() {
        if (this.editableDropDownListT != null) {
            ...
            this.stringComboBox.getItems().addAll(this.editableDropDownListT.getListItem().stream().map(listItemT -> listItemT.getUiRep()).collect(Collectors.toList()));
            //TODO check
    ...
    @Override
    public void set(EditableDropDownListT editableDropDownListT) {
